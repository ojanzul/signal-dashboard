...
/**
 * Panggil LLM (Anthropic API secara default) sebagai "analis" yang menghasilkan
 * sinyal terstruktur. Ganti fungsi ini kalau ingin pakai provider lain
 * (OpenAI, dsb) -- struktur input/output di luar fungsi ini tidak perlu berubah.
 */
